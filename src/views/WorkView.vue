...
<template>
  ...
  <div id="page-wrapper" class="desktop">
    ...
    <div id="case-links" class="section">
      <div>
        <router-link to="/coriander" class="work-link" @mouseover=' revealCaseImg("dist/cases/coriander/Coriander.jpg"); revealCaseTitle("Coriander"); revealCaseText("Recipe app conceptualised around a strong community sense with user generated content. ")' @mouseleave="hideCaseImg(); hideCaseTitle(); hideCaseText()">
        ...
        <router-link to="/gamel" class="work-link" @mouseover=' revealCaseImg("/cases/gamel/Gamel.jpg"); revealCaseTitle("Gamél"); revealCaseText("Production agency website in modern minimalist grid style.")' @mouseleave="hideCaseImg(); hideCaseTitle(); hideCaseText()">
