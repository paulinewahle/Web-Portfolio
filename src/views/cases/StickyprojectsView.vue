...
<body>
  <div class="responsive">
    ...
    <div id="responsive-container">
      <img class="resp-case-img" alt="" src="/src/assets/cases/stickyprojects/_Sticky2.jpg">
      <img class="resp-case-img" alt="" src="/src/assets/cases/stickyprojects/_Sticky3.jpg">
      <p>The digital interface for sticky notes is a Vue.js single page application connected to a SQLite database by a RestAPI in Node Express. User login is JSON web token verified.
          Illustration by Frieda Bigalke.
      </p>
      <a href="https://github.com/paulinewahle/StickyProjects" target="_blank" :style="{'z-index':'100'}"> 
        Github Code
      </a>
    </div>
  </div>
  <div class="desktop">
    ...
    <a href="https://github.com/paulinewahle/StickyProjects" target="_blank" :style="{'z-index':'100'}"> 
      ...
      <video class="cover-video" autoplay loop>
          <source src="/src/assets/cases/stickyprojects/_Sticky1.mp4" type="video/mp4">
      </video>
    </div>
    </Transition>
    <Transition :name="this.currentTransition">
    <div v-if="show2" class="page" id="page2">
      <div alt="zine-image" class="img cover-img img1"></div>
    </div>
    </Transition>
    <Transition  :name="this.currentTransition">
    <div v-if="show3" class="page" id="page3">
      <div alt="zine-image" class="img cover-img img2"></div>
    </div>
    </Transition>
    </div>
    <div id="page-numbers">
...
@media (min-width: 200px) {
  ...
  .img1{
    background-image: url('/src/assets/cases/stickyprojects/_Sticky2.jpg');
  }
  .img2{
    background-image: url('/src/assets/cases/stickyprojects/_Sticky3.jpg');
  }
}
