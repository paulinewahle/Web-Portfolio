...
<body>
  <div class="responsive">
    ...
    <div id="responsive-container">
      <img class="resp-case-img" alt="" src="/src/assets/cases/taskmanager/_Task2.jpg">
      <p>The PHP project is connected to a MySQL database holding information of a responsive neo morphism glass interface design application.
      </p>
      <a href="https://github.com/paulinewahle/phptasks" target="_blank" :style="{'z-index':'100'}"> 
        Github Code
      </a>
    </div>
  </div>
  <div class="desktop">
    ...
    <div v-if="show1" class="page" id="page1">
      ...
      <video class="cover-video" autoplay loop>
          <source src="/src/assets/cases/taskmanager/_Task1.mp4" type="video/mp4">
      </video>
    </div>
    </Transition>
    <Transition :name="this.currentTransition">
...
@media (min-width: 200px) {
  ...
  .img1{
    background-image: url('/src/assets/cases/taskmanager/_Task2.jpg');
  }
}
