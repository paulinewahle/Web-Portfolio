    ...
    <div id="about-links" class="section">
      ...
      <div id="links-wrapper">
        <div @mouseover="width2 = '80%'" @mouseleave="width2 = '40%'">
          <h3> Design </h3>
          <div target="_blank" class="about-link"><p> Behance <p class="responsive arrow">&#8227;</p> </p></div>
          <div target="_blank" class="about-link"><p> Pinterest <p class="responsive arrow">&#8227;</p> </p></div>
        </div>
        <div @mouseover="width3 = '80%'" @mouseleave="width3 = '40%'">
          <h3> Code </h3>
          <div class="about-link"><p> Github <p class="responsive arrow">&#8227;</p> </p></div>
      ...
      <a target="_blank" href = "mailto:pauline.wahle@web.de" @mouseover="width1 = '80%'" @mouseleave="width1 = '40%'">
          ...
          <div class="about-link"><p> Pauline.wahle@web.de<p class="responsive arrow">&#8227;</p> </p></div>
        </a>
